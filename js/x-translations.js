...
.config(['$translateProvider', function($translateProvider) {
	...
	$translateProvider.translations('sk', {
		...
		"menu.requests.search.lower.level":"Vyhľadať",
		"menu.requests.new.general.lower.level":"Všeobecná žiadosť",
		"menu.requests.search.general.lower.level":"Hľadať všeobecné žiadosti",
		...
		"schema.requests.basedata.domain":"Oblasť",
		"schema.requests.basedata.domain.general":"Obecné",
		"schema.requests.basedata.domain.business":"Obchod",
		"schema.requests.basedata.domain.legal":"Právo",
		...
		"schema.partner.title":"Partner",
		"schema.partner.baseData":"Základné údaje",
		"schema.partner.baseData.name":"Názov",
		"schema.partner.baseData.shown":"Zobrazovať?",
		"schema.partner.baseData.text":"Text",
		"schema.partner.logoInfo":"Logo",
		"schema.partner.logo":"Logo",
		"schema.requests.attachments":"Prílohy",
		"schema.requests.attachments":"Prílohy",
		"schema.requests.file":"Súbory",
	...
	$translateProvider.translations('cz', {
		...
		"menu.requests.new.general.lower.level":"Všeobecná žádost",
		"menu.requests.search.general.lower.level":"Hledat všeobecné žádosti",
		...
		"schema.partner.title":"Partner",
		"schema.partner.baseData":"Základní údaje",
		"schema.partner.baseData.name":"Název",
		"schema.partner.baseData.shown":"Zobrazovat?",
		"schema.partner.baseData.text":"Text",
		"schema.partner.logoInfo":"Logo",
		"schema.partner.logo":"Logo",
		"schema.requests.attachments":"Přílohy",
		"schema.requests.attachments":"Přílohy",
		"schema.requests.file":"Soubory",
...
$translateProvider.translations('en', {
		...
		"schema.people.baseData.bornNumber":"Birth certificate number",
		"schema.people.baseData.name":"Name",
		"schema.people.baseData.surName":"Surname",
		"schema.people.baseData.bornName":"Birth name",
		"schema.people.baseData.title":"Title",
		...
		"schema.people.contactInfo.phoneNumber":"Phone number",
		"schema.people.contactInfo.mobileNumber":"Mobile number",
		"schema.people.contactInfo.mobileNumber2":"Mobile number 2",
		"schema.people.contactInfo.email":"E-mail",
		"schema.people.contactInfo.email2":"E-mail 2",
		...
		"schema.people.hockeyPlayerInfo":"Player profile",
		"schema.people.hockeyPlayerInfo.category":"Competition category",
		"schema.people.hockeyPlayerInfo.clubName":"Club name",
		"schema.people.hockeyPlayerInfo.positionName":"Position name",
		"schema.people.hockeyPlayerInfo.dressNumber":"Dress number",
		"schema.people.hockeyPlayerInfo.playerHeight":"Player height",
		"schema.people.hockeyPlayerInfo.playerWeight":"Player weight",
		"schema.people.hockeyPlayerInfo.stickHandling":"Stick handling",
		"schema.people.hockeyPlayerInfo.dressSize":"Dress size",
		"schema.people.hockeyPlayerInfo.footSize":"Foot size",
		"schema.people.hockeyPlayerInfo.nickName":"Nickname",
		"schema.people.hockeyPlayerInfo.contractDate":"Contract date",
		"schema.people.hockeyPlayerInfo.registredAgentName":"Registered agent name",
		"schema.people.hockeyPlayerInfo.nonregisteredAgentName":"Non-registered agent name",
		"schema.people.hockeyPlayerInfo.category.extraliga":"Extraliga",
		"schema.people.hockeyPlayerInfo.category.nhl":"NHL",
		"schema.people.hockeyPlayerInfo.category.foreign":"Foreign",
		...
		"schema.people.hockeyPlayerInfo.dressSize.XL":"XL",
		"schema.people.hockeyPlayerInfo.dressSize.XXL":"XXL",
		"schema.people.isActivePlayer":"Is an active player",
		"schema.people.isActiveCoach":"Is an active coach",
		"schema.people.isActiveAgent":"Is an active agent",
		"schema.people.isActiveRepresentative":"Is an active representative",
		"schema.people.isProAm":"Is PRO-AM",
		"schema.people.isActivePartner":"Is an active partner",
		"schema.people.membershipFeeInfo.title":"Membership fees",
		"schema.people.membershipFeeInfo.membershipType":"Membership type",
		"schema.people.membershipFeeInfo.membershipType.extraligaUnder23":"Extraliga under 23",
		"schema.people.membershipFeeInfo.membershipType.extraligaOver23":"Extraliga over 23",
		"schema.people.membershipFeeInfo.membershipType.1.NHL":"1.NHL",
		"schema.people.membershipFeeInfo.membershipType.agent":"Agent",
		...
		"schema.people.membershipFeeInfo.paymentFrequency.1xyear":"1x per year",
		"schema.people.membershipFeeInfo.paymentFrequency.2xyear":"2x per year",
		"schema.people.membershipFeeInfo.paymentFrequency.4xyear":"4x per year",
		"schema.people.membershipFeeInfo.paymentFrequency.12xyear":"12x per year",
		"schema.people.membershipFeeInfo.membershipFee":"Membership fee",
		"schema.people.membershipFeeInfo.notes":"Notes",
		...
		"schema.requests.file":"Attachments",
		...
		"menu.payments.lower.level":"Payment Search",
		"menu.imports.new.lower.level":"New Import",
		"menu.imports.lower.level":"Import Search",

		"menu.requests.solver.title":"Request solver",
		"menu.requests.solver.search.lower.level":"Search",
		...
		"schema.fees.baseData.membershipFee":"Fee",
		"schema.fees.baseData.notes":"Notes",
		...
		"schema.org.baseData.name":"Organization name",
		...
		"schema.fees.baseData.feePaymentStatus":"Fee payment status",

		"schema.partner.title":"Partner",
		"schema.partner.baseData":"Base data",
		"schema.partner.baseData.name":"Title",
		"schema.partner.baseData.shown":"Shown?",
		"schema.partner.baseData.text":"Text",
		"schema.partner.logoInfo":"Logo",
		"schema.partner.logo":"Logo",
		"schema.requests.attachments":"Attachments",
		"schema.requests.attachments":"Attachments",
		"schema.requests.file":"Files",
		...
		"schema.payments.listFields.amount":"Amount",
		"schema.payments.listFields.status":"Status",
